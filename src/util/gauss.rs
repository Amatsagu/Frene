/* 
This was taken more or less wholesale from https://github.com/fschutt/fastblur with a few deletions.
Compared to the imagemagick/convert based blurring - this is A LOT faster since this is an approximation rather than a perfect gaussian blur, but it's close enough to not really notice that.
*/
